package pandox.china.service.cache;
...
public class CacheService {
    ...
    public ServerDTO getServerDTO() {
        return (ServerDTO) cacheManager.getCache(CACHE_SERVER_INFO).get("server.findAll");
    }

    public void putServerDTO(ServerDTO serverDTO) {
        Cache<Object, Object> cache = cacheManager.getCache(CACHE_SERVER_INFO);
        cache.put("server.findAll", serverDTO, 5, TimeUnit.MINUTES);
    }
